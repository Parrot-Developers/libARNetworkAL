...
#define ARNETWORKAL_WIFINETWORK_SENDING_BUFFER_SIZE     ARNETWORKAL_WIFINETWORK_MAX_BUFFER_SIZE
#define ARNETWORKAL_WIFINETWORK_RECEIVING_BUFFER_SIZE   ARNETWORKAL_WIFINETWORK_MAX_BUFFER_SIZE
